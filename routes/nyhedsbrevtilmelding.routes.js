...
router.post('/', async (req, res) => {
    ...
    var mailOptions = {
        ...
        text: ``,
        html: '<h1>Hej med dig!</h1><p>Velkommen til vores nyhedsbrev, vi vil ikke spamme dig, men derimod sende et nyhedsbrev ud om ugen.</p>'
    };
    ...
    if (tilmelding) {
        ...
        return res.status(201).json({ message: "Der er sket en fejl, prøv igen.." })
