...
db.once('open', () => console.log("///// Halløjsa - her er din DATABASE! /////"));
...
app.get('/', async (req, res) => {
    console.log("HEJ og velkommen serverens startside - vælg en route hvis du vil have andet end bare lidt console.log-snak!")
});
...
// LISTEN --------------------------------------------------------------------------------------------------
app.listen(PORT, () => console.log('///// Din SERVER er eksamensklar, fuld af krudt og lytter for vildt på port ' + PORT + " /////"));
